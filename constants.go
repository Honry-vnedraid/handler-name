...
Дай свою экспертную оценку в виде числа с плавающей запятой в диапазоне от -1 до 1 включительно, где 1 - это очень сильный рост, -1 - очень сильное падение, а 0 - останется без изменений. 
